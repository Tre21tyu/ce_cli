            ...
            if (line.includes('(||)')) {
                ...
                if (serviceMatch) {
                    ...
                    if (!isNaN(timestamp.getTime())) {
                        ...
                        console.log(chalk_1.default.gray(`Found already processed service: ${verb}${noun ? ", " + noun : ""} at ${datetime}`));
                    }
                }
                continue;
            }
            ...
            if (serviceMatch) {
                ...
                if (previousTimestamp && !isNaN(timestamp.getTime())) {
                    ...
                    if (timestamp.getTime() > previousTimestamp.getTime()) {
                        ...
                        console.log(chalk_1.default.yellow(`Service timestamp (${timestamp.toISOString()}) is not after previous timestamp (${previousTimestamp.toISOString()})`));
